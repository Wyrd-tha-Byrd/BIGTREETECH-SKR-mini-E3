...
(function (Chart) {
  ...
  Chart.controllers.linearGauge = Chart.DatasetController.extend({
    ...
    updateElement: function updateElement(rectangle, index, reset) {
      ...
      rectangle.rangeColorImage = null; //	Init element model
    ...
    updateElementGeometry: function updateElementGeometry(rectangle, index, reset) {
      ...
      var gaugeOptions = chart.options.elements.gaugerect;
      var vscale = me.getScaleForId(chart.options.scale.id || 'gaugescale'); //var base = vscale.getBasePixel();

      var base = vscale.getBase();

      var horizontal = rectangle._Scale.isHorizontal(); //var ruler = me._ruler || me.getRuler();
    ...
    calculateBarValuePixels: function calculateBarValuePixels(datasetIndex, index, horizontal) {
      var me = this;
      var chart = me.chart;
